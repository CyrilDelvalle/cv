            ...
            <table className="ml-2 mt-2 w-full">
                <tbody className='w-full'>
                    <tr>
                        ...
                        <td className='w-40'>
                            <div className="my-2 h-4 bg-gray-200 rounded dark:bg-gray-700 mr-2">
                                <div className="h-4 bg-amber-600 rounded" style={{ width: "80%" }}></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div className="my-2 h-4 bg-gray-200 rounded dark:bg-gray-700 mr-2">
                                <div className="h-4 bg-amber-600 rounded" style={{ width: "60%" }}></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div className="my-2 h-4 bg-gray-200 rounded dark:bg-gray-700 mr-2">
                                <div className="h-4 bg-amber-600 rounded" style={{ width: "65%" }}></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div className="my-2 h-4 bg-gray-200 rounded dark:bg-gray-700 mr-2">
                                <div className="h-4 bg-amber-600 rounded" style={{ width: "50%" }}></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
